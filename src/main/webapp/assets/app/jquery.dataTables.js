  ...
  var DataTable = function (oInit) {
        ...
        if (
          ...
          _fnLog(
            ...
            "Requested unknown parameter " +
              (typeof oCol.mDataProp == "function"
                ? "{mDataprop function}"
                : "'" + oCol.mDataProp + "'") +
    ...
    function _fnSetObjectDataFn(mSource) {
      if (mSource === null) {
        ...
        // Split the string and check for nested object assignment
        var a = mSource.split(".");
        return function (data, val) {
          ...
          // Ensure we're not assigning to dangerous properties like __proto__ or constructor
          if (
            a[a.length - 1] === "__proto__" ||
            a[a.length - 1] === "constructor"
          ) {
            return;
          }
        ...
        // Array or flat object mapping
        return function (data, val) {
          // Same check for direct assignment
          if (mSource === "__proto__" || mSource === "constructor") {
            return;
          }
          data[mSource] = val;
        };
    ...
    function _fnDataToSearch(sData, sType) {
      if (typeof DataTable.ext.ofnSearch[sType] === "function") {
        ...
        // Remove HTML tags and line breaks with improved regular expression
        let previous;
        do {
          previous = sData;
          sData = sData.replace(/[\r\n]/g, " ").replace(/<.*?>/g, "");
        } while (sData !== previous); // Repeat until no more replacements are found
        return sData;
    ...
    function _fnGetMaxLenString(oSettings, iCol) {
      ...
      for (var i = 0; i < oSettings.aoData.length; i++) {
        ...
        // Apply the regex replacement repeatedly until no more tags are found
        var previous;
        do {
          previous = s;
  ...
  DataTable.defaults = {
    ...
    fnServerData: function (sUrl, aoData, fnCallback, oSettings) {
      ...
      if (
        oSettings &&
        oSettings.oInit &&
        oSettings.oInit.more_data &&
        !$.isEmptyObject(oSettings.oInit.more_data)
      ) {
